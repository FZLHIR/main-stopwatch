...
#define UI_THEME_COLOR_CHROME_YELLOW 2

#define UI_THEME_DEFAULT 0

#define UI_THEME_YEE 1
...
extern const ui_theme_variable_t _ui_theme_color_CHROME_YELLOW[2];
extern const ui_theme_variable_t _ui_theme_alpha_CHROME_YELLOW[2];
